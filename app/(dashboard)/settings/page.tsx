            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-lg bg-background/60 border border-border/50">
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className={`w-12 h-6 rounded-full transition ${notificationsEnabled ? 'bg-green-500' : 'bg-gray-400'}`}
                  >
                    <div className={`w-5 h-5 rounded-full bg-white transition ${notificationsEnabled ? 'ml-6' : 'ml-0.5'}`}></div>
                  </button>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-background/60 border border-border/50">
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    className="w-12 h-6 rounded-full bg-green-500 transition"
                  >
                    <div className="w-5 h-5 rounded-full bg-white ml-6"></div>
                  </button>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-background/60 border border-border/50">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button 
                    ...
                    className={`w-12 h-6 rounded-full transition ${pushNotifications ? 'bg-green-500' : 'bg-gray-400'}`}
                  >
                    <div className={`w-5 h-5 rounded-full bg-white transition ${pushNotifications ? 'ml-6' : 'ml-0.5'}`}></div>
                  </button>
                </div>
              ...
              <div className="p-4 rounded-lg bg-background/60 border border-border/50">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button 
                    ...
                    className={`w-12 h-6 rounded-full transition ${emailNotifications ? 'bg-green-500' : 'bg-gray-400'}`}
                  >
                    <div className={`w-5 h-5 rounded-full bg-white transition ${emailNotifications ? 'ml-6' : 'ml-0.5'}`}></div>
                  </button>
                </div>
